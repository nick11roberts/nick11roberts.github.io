...
- **(September 2026)** Excited to start my next chapter as a Postdoctoral Research Fellow at [Princeton Language and Intelligence][pli]! 
- **(May - August 2026)** I am collaborating with [Jane Street][js] as a Machine Learning Student Research Intern this summer in New York! 
- **(May 2026)** I defended and graduated with my Ph.D. from UW-Madison. Thank you to Fred, my committee, my family, and to all of my amazing friends who unlocked this path for me. 

<!--
- Excited to visit [Chris Ré's lab][hazy] at [Stanford University][stanford] this August! 
- Two papers accepted to [COLM 2025][colm25]! 
  - [Manticore][manticore] for constructing pretrained hybrids from non-hybrid base models without pretraining! 
  - [Meta MLGym][mlgym]: a framework for benchmarking and developing agents for AI research! 
- Presented at [ACL 2025][acl25]: 
  - We discover a [new scaling law phenomenon][cos]! **Compute optima for knowledge favor larger models, whereas those for reasoning favor more data.** 
...
[hazy]: #
[stanford]: #
[manticore]: https://arxiv.org/abs/2406.00894
[acl25]: #
[colm25]: #
