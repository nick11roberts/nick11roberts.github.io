...
This Summer, I am interning at [Together AI][together] in San Francisco, where I am working with [Tri Dao][tri]. 
In the Fall, I will be in London working on Llama evaluation with [Meta Generative AI][meta], and supervised by [Dieuwke Hupkes][dh]. 
In Summer 2023, I interned with the Physics of AGI research group at [Microsoft Research][msr] led by [Sébastien Bubeck][seb], where I also worked on large language models.
