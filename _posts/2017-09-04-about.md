...
I have completed research internships at [Meta's Llama team][meta] (working on scaling laws with [Dieuwke Hupkes][dh]), [Together AI][together] (hybrid language models with [Tri Dao][tri]), and [Microsoft Research][msr] (Physics of AGI group with [Sébastien Bubeck][seb]). I received an honorable mention for the [Jane Street Graduate Research Fellowship][js] (2025) and was named an [MLCommons][mlcommons] [Rising Star][mlsys_rising_stars] (2023).
