...
I am a Ph.D. candidate in Computer Science at [University of Wisconsin--Madison][wisc], advised by [Fred Sala][fred] in the [Sprocket Lab][sprocket], where I work on the science of foundation model scaling, data-efficiency, and adaptation to high-impact scientific domains---all with the ultimate goal of developing powerful scientific research agents. 
...
My academic path began at [Fresno City College][fcc] before earning my B.S. at [UC San Diego][ucsd] (working with [Sanjoy Dasgupta][sanjoy] and [Gary Cottrell][gary]) and M.S. at [Carnegie Mellon University][cmu] (working with [Ameet Talwalkar][ameet] and [Zack Lipton][zack]).
