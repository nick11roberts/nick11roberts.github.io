...
In 2025 I received an honorable mention for the [Jane Street Graduate Research Fellowship][jsgrfp] and in 2023, I was named an [MLCommons][mlcommons] [Rising Star][mlsys_rising_stars]. I have also been awarded the Prove AI and UnifyID AI Fellowships in 2021 and 2019, respectively. 
-->


I am a Postdoctoral Research Fellow at [Princeton Language and Intelligence][pli] working with [Sanjeev Arora][sanjeev]'s and [Danqi Chen][danqi]'s groups. I work on the science of foundation model scaling, data-efficiency, and adaptation to high-impact scientific domains---all with the ultimate goal of developing powerful scientific research agents. 

I have completed research internships at [Jane Street][js] (part of their first ever cohort of ML student research interns), [Meta's Llama team][meta] (working on scaling laws with [Dieuwke Hupkes][dh]), [Together AI][together] (hybrid language models with [Tri Dao][tri]), and [Microsoft Research][msr] (Physics of AGI group with [Sébastien Bubeck][seb]). I received an honorable mention for the [Jane Street Graduate Research Fellowship][jsgrfp] (2025) and was named an [MLCommons][mlcommons] [Rising Star][mlsys_rising_stars] (2023). 

I earned my Ph.D. in Computer Science from the [University of Wisconsin--Madison][wisc] where I was advised by [Fred Sala][fred] in the [Sprocket Lab][sprocket]. My academic path began at [Fresno City College][fcc] before earning my B.S. at [UC San Diego][ucsd] where I worked with [Gary Cottrell][gary] and [Sanjoy Dasgupta][sanjoy] and M.S. at [Carnegie Mellon University][cmu] with [Ameet Talwalkar][ameet] and [Zack Lipton][zack]. 
...
[sanjeev]: https://aroraresearch-princeton.github.io
[danqi]: https://www.cs.princeton.edu/~danqic/
...
[jsgrfp]: https://www.janestreet.com/join-jane-street/programs-and-events/grf-profiles-2025/
