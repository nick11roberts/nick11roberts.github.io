...
3. developing data efficient foundation model training and adaptation techniques, and 
4. adapting foundation model pipelines to non-standard scientific domains. 
