...
ga('create', 'UA-53407536-2', 'auto') ; 
ga('require', 'linkid');
ga('send', 'pageview');</script><script>var trackOutboundLink = function(url) {
  ga('send', 'event', 'outbound', 'click', url, {
    'transport': 'beacon',
    'hitCallback': function(){document.location = url;}
  });
}</script><script src="https://code.jquery.com/jquery-3.1.0.min.js" integrity="sha256-cCueBR6CsyA4/9szpPfrX3s49M9vUU5BgtiJj06wt/s=" crossorigin="anonymous"></script><script src="https://use.fontawesome.com/9fb8fdf036.js"></script><!-- Load the Paper.js library--><script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/paper.js/0.10.2/paper-full.min.js"></script><script type="text/javascript" src="/javascript/parallax.js-1.4.2/parallax.min.js"></script><script type="text/javascript" src="/node_modules/rpolygon/rpolygon.js"></script><script type="text/javascript" src="/node_modules/typewriter/build/typewriter-bundle.js"></script><script type="text/javascript" src="/javascript/index.js"></script><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css"><link href="https://fonts.googleapis.com/css?family=Italiana|Abril+Fatface|Dosis" rel="stylesheet"><link rel="stylesheet" href="/stylesheets/Skeleton-2.0.4/css/skeleton.css"><link type="text/css" rel="stylesheet" href="/stylesheets/index.css"><link rel="apple-touch-icon" sizes="57x57" href="/apple-icon-57x57.png"><link rel="apple-touch-icon" sizes="60x60" href="/apple-icon-60x60.png"><link rel="apple-touch-icon" sizes="72x72" href="/apple-icon-72x72.png"><link rel="apple-touch-icon" sizes="76x76" href="/apple-icon-76x76.png"><link rel="apple-touch-icon" sizes="114x114" href="/apple-icon-114x114.png"><link rel="apple-touch-icon" sizes="120x120" href="/apple-icon-120x120.png"><link rel="apple-touch-icon" sizes="144x144" href="/apple-icon-144x144.png"><link rel="apple-touch-icon" sizes="152x152" href="/apple-icon-152x152.png"><link rel="apple-touch-icon" sizes="180x180" href="/apple-icon-180x180.png"><link rel="icon" type="image/png" sizes="192x192" href="/android-icon-192x192.png"><link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png"><link rel="icon" type="image/png" sizes="96x96" href="/favicon-96x96.png"><link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png"><link rel="manifest" href="/manifest.json"><meta name="msapplication-TileColor" content="#ffffff"><meta name="msapplication-TileImage" content="/ms-icon-144x144.png"><meta name="theme-color" content="#ffffff"><title>Nicholas Roberts</title></head><body><canvas id="background">Your browser does not support the canvas element. </canvas><h1>Stream</h1><pre><code>Stability: 2 - Stable
...
<a href="https://nodejs.org/docs/v6.3.1/api/http.html#http_class_http_incomingmessage">request to an HTTP server</a> and <a href="https://nodejs.org/docs/v6.3.1/api/process.html#process_process_stdout"><code>process.stdout</code></a>
are both stream instances.</p>
<p>Streams can be readable, writable, or both. All streams are instances of
<a href="https://nodejs.org/docs/v6.3.1/api/events.html#events_class_eventemitter"><code>EventEmitter</code></a>.</p>
...
<h2>Organization of this document</h2><p>This document is divided into two primary sections and third section for
...
<h2>Types of Streams</h2><p>There are four fundamental stream types within Node.js:</p>
<ul>
<li><a href="#stream_class_stream_readable">Readable</a> - streams from which data can be read (for example
<a href="https://nodejs.org/docs/v6.3.1/api/fs.html#fs_fs_createreadstream_path_options"><code>fs.createReadStream()</code></a>).</li>
<li><a href="#stream_class_stream_writable">Writable</a> - streams to which data can be written (for example
<a href="https://nodejs.org/docs/v6.3.1/api/fs.html#fs_fs_createwritestream_path_options"><code>fs.createWriteStream()</code></a>).</li>
<li><a href="#stream_class_stream_duplex">Duplex</a> - streams that are both Readable and Writable (for example
<a href="https://nodejs.org/docs/v6.3.1/api/net.html#net_class_net_socket"><code>net.Socket</code></a>).</li>
<li><a href="#stream_class_stream_transform">Transform</a> - Duplex streams that can modify or transform the data as it
is written and read (for example <a href="https://nodejs.org/docs/v6.3.1/api/zlib.html#zlib_zlib_createdeflate_options"><code>zlib.createDeflate()</code></a>).</li>
</ul>
<h3>Object Mode</h3><p>All streams created by Node.js APIs operate exclusively on strings and <code>Buffer</code>
...
appropriate and efficient flow of data. For example, <a href="https://nodejs.org/docs/v6.3.1/api/net.html#net_class_net_socket"><code>net.Socket</code></a> instances
...
the other.</p>
<h2>API for Stream Consumers</h2><!--type=misc-->
...
<p><a href="#stream_class_stream_readable">Readable</a> streams use the <a href="https://nodejs.org/docs/v6.3.1/api/events.html#events_class_eventemitter"><code>EventEmitter</code></a> API for notifying application
code when data is available to be read off the stream. That available data can
be read from the stream in multiple ways.</p>
<p>Both <a href="#stream_class_stream_writable">Writable</a> and <a href="#stream_class_stream_readable">Readable</a> streams use the <a href="https://nodejs.org/docs/v6.3.1/api/events.html#events_class_eventemitter"><code>EventEmitter</code></a> API in
...
<h3>Writable Streams</h3><p>Writable streams are an abstraction for a <em>destination</em> to which data is
written.</p>
<p>Examples of <a href="#stream_class_stream_writable">Writable</a> streams include:</p>
<ul>
<li><a href="https://nodejs.org/docs/v6.3.1/api/http.html#http_class_http_clientrequest">HTTP requests, on the client</a></li>
<li><a href="https://nodejs.org/docs/v6.3.1/api/http.html#http_class_http_serverresponse">HTTP responses, on the server</a></li>
<li><a href="https://nodejs.org/docs/v6.3.1/api/fs.html#fs_class_fs_writestream">fs write streams</a></li>
<li><a href="zlib.html">zlib streams</a></li>
<li><a href="crypto.html">crypto streams</a></li>
<li><a href="https://nodejs.org/docs/v6.3.1/api/net.html#net_class_net_socket">TCP sockets</a></li>
<li><a href="https://nodejs.org/docs/v6.3.1/api/child_process.html#child_process_child_stdin">child process stdin</a></li>
<li><a href="https://nodejs.org/docs/v6.3.1/api/process.html#process_process_stdout"><code>process.stdout</code></a>, <a href="https://nodejs.org/docs/v6.3.1/api/process.html#process_process_stderr"><code>process.stderr</code></a></li>
</ul>
...
<h4>Class: stream.Writable</h4><!-- YAML
added: v0.9.4
-->
<!--type=class-->
<h5>Event: &#39;close&#39;</h5><!-- YAML
added: v0.9.4
-->
...
<h5>writable.end([chunk][, encoding][, callback])</h5><!-- YAML
added: v0.9.4
-->
<ul>
...
<h5>writable.setDefaultEncoding(encoding)</h5><!-- YAML
added: v0.11.15
-->
<ul>
...
</code></pre><h5>writable.write(chunk[, encoding][, callback])</h5><!-- YAML
added: v0.9.4
-->
<ul>
...
<h3>Readable Streams</h3><p>Readable streams are an abstraction for a <em>source</em> from which data is
consumed.</p>
<p>Examples of Readable streams include:</p>
<ul>
<li><a href="https://nodejs.org/docs/v6.3.1/api/http.html#http_class_http_incomingmessage">HTTP responses, on the client</a></li>
<li><a href="https://nodejs.org/docs/v6.3.1/api/http.html#http_class_http_incomingmessage">HTTP requests, on the server</a></li>
<li><a href="https://nodejs.org/docs/v6.3.1/api/fs.html#fs_class_fs_readstream">fs read streams</a></li>
<li><a href="zlib.html">zlib streams</a></li>
<li><a href="crypto.html">crypto streams</a></li>
<li><a href="https://nodejs.org/docs/v6.3.1/api/net.html#net_class_net_socket">TCP sockets</a></li>
<li><a href="https://nodejs.org/docs/v6.3.1/api/child_process.html#child_process_child_stdout">child process stdout and stderr</a></li>
<li><a href="https://nodejs.org/docs/v6.3.1/api/process.html#process_process_stdin"><code>process.stdin</code></a></li>
</ul>
...
<h4>Two Modes</h4><p>Readable streams effectively operate in one of two modes: flowing and paused.</p>
<p>When in flowing mode, data is read from the underlying system automatically
and provided to an application as quickly as possible using events via the
<a href="https://nodejs.org/docs/v6.3.1/api/events.html#events_class_eventemitter"><code>EventEmitter</code></a> interface.</p>
...
from the stream.</p>
<h4>Three States</h4><p>The &quot;two modes&quot; of operation for a Readable stream are a simplified abstraction
...
<h4>Choose One</h4><p>The Readable stream API evolved across multiple Node.js versions and provides
...
use the <a href="https://nodejs.org/docs/v6.3.1/api/events.html#events_class_eventemitter"><code>EventEmitter</code></a> and <code>readable.pause()</code>/<code>readable.resume()</code> APIs.</p>
<h4>Class: stream.Readable</h4><!-- YAML
added: v0.9.4
-->
<!--type=class-->
<h5>Event: &#39;close&#39;</h5><!-- YAML
...
<h5>readable.pipe(destination[, options])</h5><!-- YAML
added: v0.9.4
-->
<ul>
...
<pre><code class="language-js">const r = fs.createReadStream(&#39;file.txt&#39;);
...
<p><em>Note</em>: The <a href="https://nodejs.org/docs/v6.3.1/api/process.html#process_process_stderr"><code>process.stderr</code></a> and <a href="https://nodejs.org/docs/v6.3.1/api/process.html#process_process_stdout"><code>process.stdout</code></a> Writable streams are
never closed until the Node.js process exits, regardless of the specified
options.</p>
<h5>readable.read([size])</h5><!-- YAML
added: v0.9.4
-->
<ul>
...
<h5>readable.setEncoding(encoding)</h5><!-- YAML
added: v0.9.4
-->
<ul>
...
<h5>readable.unpipe([destination])</h5><!-- YAML
added: v0.9.4
-->
<ul>
...
<h5>readable.unshift(chunk)</h5><!-- YAML
added: v0.9.11
-->
<ul>
...
<h5>readable.wrap(stream)</h5><!-- YAML
added: v0.9.4
-->
<ul>
...
libraries.</p>
<p>For example:</p>
<pre><code class="language-js">const OldReader = require(&#39;./old-api-module.js&#39;).OldReader;
...
<h3>Duplex and Transform Streams</h3><h4>Class: stream.Duplex</h4><!-- YAML
added: v0.9.4
-->
<!--type=class-->
...
<h4>Class: stream.Transform</h4><!-- YAML
added: v0.9.4
-->
<!--type=class-->
...
<h2>API for Stream Implementers</h2><!--type=misc-->
...
<pre><code class="language-js">const Writable = require(&#39;stream&#39;).Writable;
...
<h3>Simplified Construction</h3><p>For many simple cases, it is possible to construct a stream without relying on
...
<h3>Implementing a Writable Stream</h3><p>The <code>stream.Writable</code> class is extended to implement a <a href="#stream_class_stream_writable">Writable</a> stream.</p>
...
<h4>Constructor: new stream.Writable([options])</h4><ul>
...
<h4>writable._write(chunk, encoding, callback)</h4><ul>
...
user programs.</p>
<h4>writable._writev(chunks, callback)</h4><ul>
...
internal to the class that defines it, and should never be called directly by
user programs.</p>
<h4>Errors While Writing</h4><p>It is recommended that errors occurring during the processing of the
...
<h4>An Example Writable Stream</h4><p>The following illustrates a rather simplistic (and somewhat pointless) custom
...
<h3>Implementing a Readable Stream</h3><p>The <code>stream.Readable</code> class is extended to implement a <a href="#stream_class_stream_readable">Readable</a> stream.</p>
...
<h4>new stream.Readable([options])</h4><ul>
<li><code>options</code> {Object}<ul>
...
internal to the class that defines it, and should never be called directly by
user programs.</p>
<h4>readable.push(chunk[, encoding])</h4><ul>
...
<h4>Errors While Reading</h4><p>It is recommended that errors occurring during the processing of the
...
<h4>An Example Counting Stream</h4><!--type=example-->
...
<h3>Implementing a Duplex Stream</h3><p>A <a href="#stream_class_stream_duplex">Duplex</a> stream is one that implements both <a href="#stream_class_stream_readable">Readable</a> and <a href="#stream_class_stream_writable">Writable</a>,
...
<h4>new stream.Duplex(options)</h4><ul>
...
<p>For example:</p>
<pre><code class="language-js">const Duplex = require(&#39;stream&#39;).Duplex;
...
<h4>An Example Duplex Stream</h4><p>The following illustrates a simple example of a Duplex stream that wraps a
...
object instance.</p>
<h4>Object Mode Duplex Streams</h4><p>For Duplex streams, <code>objectMode</code> can be set exclusively for either the Readable
...
the Readable side.</p>
<pre><code class="language-js">const Transform = require(&#39;stream&#39;).Transform;
...
<h3>Implementing a Transform Stream</h3><p>A <a href="#stream_class_stream_transform">Transform</a> stream is a <a href="#stream_class_stream_duplex">Duplex</a> stream where the output is computed
...
<h4>new stream.Transform([options])</h4><ul>
<li><code>options</code> {Object} Passed to both Writable and Readable
constructors. Also has the following fields:<ul>
...
<h4>Events: &#39;finish&#39; and &#39;end&#39;</h4><p>The <a href="#stream_event_finish"><code>&#39;finish&#39;</code></a> and <a href="#stream_event_end"><code>&#39;end&#39;</code></a> events are from the <code>stream.Writable</code>
...
<h4>transform._flush(callback)</h4><ul>
<li><code>callback</code> {Function} A callback function (optionally with an error
...
internal to the class that defines it, and should never be called directly by
user programs.</p>
<h4>transform._transform(chunk, encoding, callback)</h4><ul>
...
user programs.</p>
<h4>Class: stream.PassThrough</h4><p>The <code>stream.PassThrough</code> class is a trivial implementation of a <a href="#stream_class_stream_transform">Transform</a>
stream that simply passes the input bytes across to the output. Its purpose is
primarily for examples and testing, but there are some use cases where
<code>stream.PassThrough</code> is useful as a building block for novel sorts of streams.</p>
<h2>Additional Notes</h2><!--type=misc-->
<h3>Compatibility with Older Node.js Versions</h3><!--type=misc-->
...
<h3><code>readable.read(0)</code></h3><p>There are some cases where it is necessary to trigger a refresh of the
...
<h3><code>readable.push(&#39;&#39;)</code></h3><p>Use of <code>readable.push(&#39;&#39;)</code> is not recommended.</p>
...
readable buffer so there is nothing for a user to consume.</p></body></html>